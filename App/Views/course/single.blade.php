...
<head>
    ...
    <title>Edu School - Education Category Bootstrap Responsive Website Template - Blog Single : W3Layouts</title>
    <!-- Google fonts -->
...
<div id="right-sidebar" class="right-sidebar-notifcations nav-collapse">
    <div class="bs-example bs-example-tabs right-sidebar-tab-notification" data-example-id="togglable-tabs">
        ...
        <div id="w3lDemoBar" class="w3l-demo-bar">
            <div class="demo-btns">
                <a href="https://w3layouts.com/?p=4763800000100095">
            ...
            <span class="w3l-icon -download">
                ...
                <a href="https://w3layouts.com/checkout/?add-to-cart=4763800000100095" class="no-margin-bottom-mobile">
        ...
        <div class="row">
            <div class="text-11 col-lg-8">
                <div class="text11-content">
                    <h4>The Challenge Of Global Learning In Public Education</h4>
                    <img src="assets/images/blog-single.jpg" class="img-fluid radius-image" alt="" />
                    <p class="mt-4">Lorem faucibus fusce ante vitae justo efficitur elementum. Donec ipsum faucibus
                        arcu elementum, luctus justo. ac purus semper. Fusce faucibus ante vitae justo efficitur
                        elementum. Donec ipsum faucibus. Donec ipsum faucibus arcu elementum. Donec ipsum
                        faucibus arcu elementum, luctus justo. ac purus semper. Fusce faucibus ante vitae
                        justo efficitur elementum.</p>
                    <p class="mt-4">Fusce faucibus ante vitae justo efficitur elementum. Donec ipsum faucibus arcu elementum,
                        luctus
                    ...
                    <p class="mt-md-4 mt-3">Fusce faucibus ante vitae justo efficitur elementum. Donec ipsum
                        faucibus arcu elementum,
                        luctus
                        justo. ac purus semper. Fusce faucibus ante vitae justo efficitur elementum. Donec ipsum
                        faucibus
                        arcu elementum, luctus justo. ac purus semper."</p>
                    <h5 class="quote">“Education is the passport to the future, for tomorrow belongs to those who
                        prepare for it today.”
                        <footer class="blockquote-footer mt-3">Malcolm X </footer>
                    </h5>

                    <p>Lorem faucibus fusce ante vitae justo efficitur elementum. Donec ipsum faucibus arcu
                        elementum,
                        luctus
                        justo. ac purus semper. Fusce faucibus ante vitae justo efficitur elementum. Donec ipsum
                        faucibus. Fusce faucibus ante vitae justo efficitur elementum.</p>
                    ...
                    <div class="nav-links">
                        <div class="nav-previous">
                            <a href="#url" rel="prev">
                                <img src="assets/images/blog-s1.jpg" alt="" class="img-fluid radius-image" />
                        ...
                        <div class="nav-next text-end">
                            <a href="#url" rel="next">
                                ...
                                <img src="assets/images/blog-s2.jpg" alt="" class="img-fluid radius-image" />
                            </a>
                        </div>
                    </div>
                    <div class="comments">
                        ...
                        <div class="comments-grids">
                            <div class="media-grid">
                                <div class="media">
                                    <a class="com" href="#"><img src="assets/images/testi2.jpg"
                                                                 class="img-fluid radius-image" width="100px"
                                                                 alt="placeholder image"></a>
                                    <div class="media-body comments-grid-right">
                                        <h5>Elexa kim</h5>
                                        <ul class="p-0">
                                            <li class="">Oct 28, 2021.
                                            </li>
                                            <li>
                                                <a href="#comment" class="">Reply</a>
                                            </li>
                                        </ul>
                                        <p>Mattis ut hendrerit non, facilisis eget mauris. Sed ultricies nec purus
                                            quis
                                            tempor. ipsum eu nec purus quis tempor dolor set.</p>
                            ...
                            <div class="media-grid even-grid">
                                <div class="media">
                                    <a class="com" href="#"><img src="assets/images/testi3.jpg"
                                                                 class="img-fluid radius-image" width="100px"
                                                                 alt="placeholder image"></a>
                                    <div class="media-body comments-grid-right">
                                        <h5>Charlie</h5>
                            ...
                            <div class="media-grid">
                                <div class="media">
                                    <a class="com" href="#"><img src="assets/images/testi1.jpg"
                                                                 class="img-fluid radius-image" width="100px"
                                                                 alt="placeholder image"></a>
                                    <div class="media-body comments-grid-right">
                                        <h5>Jack Harry</h5>
                                        ...
                                        <p>Mattis ut hendrerit non, facilisis eget mauris. Sed ultricies nec purus
                                            quis
                                            tempor, ipsum bibendum purus quis tempor.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="leave-comment-form" id="comment">
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="submit text-end">
                                <button class="btn btn-style btn-style-3 mt-2">Post Comment</button>
                            </div>
                        </form>
                    </div>
                </div>
