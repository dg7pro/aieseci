...
<nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom shadow-sm">
    <a class="navbar-brand mt-1 mb-2" href="{{'/'}}"> AIESECI Institute</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
            @if($authUser)
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{'/subscribe/index'}}"><mark> History</mark></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{'/subscribe/index'}}"><mark> Contact</mark></a>
                </li>
               {{-- <li class="nav-item">
