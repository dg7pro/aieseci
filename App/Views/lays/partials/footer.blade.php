        ...
        <div class="container pt-md-4">
            <div class="row footer-top-29">
                <div class="col-lg-4 col-md-6 footer-list-29">
                    ...
                    <p class="mb-2 pe-xl-5">Address : AIESECI Building, C-29/69, Near Sant Nirankari Bhawan, Lohamandi, Maldahiya, Varanasi.(U.P).</p>
                    <p class="mb-2">Phone Number : <a href="tel:+1(21) 234 4567">+91 9415301989</a></p>
                    <p class="mb-2">Email : <a href="mailto:info@example.com">aieseci09@gmail.com</a></p>
                </div>
                ...
                <div class="col-lg-2 col-md-3 col-6 ps-lg-5 ps-lg-4 footer-list-29 mt-md-0 mt-4">
                    <ul>
                        ...
                        <li><a href="javascript:void(0);">License & uses</a></li>
            ...
            <!-- copyright -->
            <p class="copy-footer-29 text-center pt-lg-2 mt-5 pb-2">© 2022 AIESECI Inst. All rights reserved. Design
                by <a href="javascript:void(0);" target="_blank">AIESECI IT Lab</a></p>
            <!-- //copyright -->
        </div>
    </div>
</footer>
