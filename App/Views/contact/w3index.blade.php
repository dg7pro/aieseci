                        ...
                        <div class="cont-details">
                            <div class="d-flex contact-grid">
                                ...
                                <div class="cont-right">
                                    <h6>AIESECI Institute</h6>
                                    <p>C-29/69, Lohamandi, Maldahiya - 221001, Varanasi.(U.P).</p>
                                </div>
                            </div>
                            <div class="d-flex contact-grid mt-4 pt-lg-2">
                                ...
                                <div class="cont-right">
                                    <h6>Call Us</h6>
                                    <p><a href="tel:+1(21) 234 4567">+91-9415301989</a></p>
                                </div>
                            </div>
                            <div class="d-flex contact-grid mt-4 pt-lg-2">
                                <div class="cont-left text-center me-3">
                                ...
                                <div class="cont-right">
                                    <h6>Email Us</h6>
                                    <p><a href="mailto:example@mail.com" class="mail">aieseci09@gmail.com</a></p>
                                </div>
                            </div>
                            <div class="d-flex contact-grid mt-4 pt-lg-2">
                                <div class="cont-left text-center me-3">
                                ...
                                <div class="cont-right">
                                    ...
                                    <p><a href="mailto:info@support.com" class="mail">info@aieseci.co.in</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
